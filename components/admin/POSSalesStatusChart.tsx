...
/**
 * Horizontal bar chart showing POS sales count by payment status.
 * Uses CSS variables for colors and vanilla rendering.
 */
export function POSSalesStatusChart({
  ...
  useEffect(() => {
    ...
    getPOSSalesByStatus(start, end)
      ...
      .catch((err) => {
        console.error("Failed to load POS sales status:", err)
