...
export default function CartPage() {
  ...
  if (items.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-20 bg-white rounded-xl shadow-sm border mt-10">
        <h2 className="text-2xl font-bold text-gray-800">Tu carrito está vacío</h2>
        <p className="text-gray-500 mt-2">Parece que no has agregado nada todavía.</p>
        <Link href="/" className="mt-6 bg-blue-500 text-white px-6 py-2 rounded-lg font-medium hover:bg-blue-600 transition">
          Volver a la tienda
        </Link>
      </div>
    );
  ...
  return (
    <div className="mt-4 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          {items.map((item) => (
            <div key={item.id} className="relative flex p-4 bg-white rounded-xl shadow-sm border items-center">
              ...
              <div className="ml-6 flex-1 flex flex-col justify-center">
                ...
                <p className="text-sm text-gray-400 mb-1">Producto verificado</p>
              ...
              <div className="flex flex-col items-end justify-between self-stretch">
                <button 
                  ...
                  className="text-red-400 hover:text-red-600 p-1 mb-auto transition"
                ...
                <div className="flex items-center space-x-3 mt-auto">
                  <button 
                    ...
                    className="w-8 h-8 flex items-center justify-center rounded-md border text-gray-500 hover:bg-gray-100 transition"
                  >
        ...
        {/* Right Side: Resumen */}
        <div className="w-full lg:w-1/3 bg-white rounded-xl shadow-sm border p-6 sticky top-24">
          <h2 className="text-xl font-extrabold text-gray-900 mb-6">Resumen</h2>
          ...
          <Link href="/checkout" className="block w-full text-center bg-blue-500 text-white py-3 rounded-lg font-semibold hover:bg-blue-600 transition shadow-sm">
            Proceder al Pago
          </Link>
        </div>
      </div>
